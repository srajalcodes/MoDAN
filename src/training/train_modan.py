...
def main():
    ...
    train_loader = DataLoader(MultimodalDDIDataset(args.train_csv, chem, esm, bio, c_dim, e_dim, b_dim), batch_size=512, shuffle=True, pin_memory=True)
    s1_loader = DataLoader(MultimodalDDIDataset(args.s1_csv, chem, esm, bio, c_dim, e_dim, b_dim), batch_size=512, shuffle=False)
    s2_loader = DataLoader(MultimodalDDIDataset(args.s2_csv, chem, esm, bio, c_dim, e_dim, b_dim), batch_size=512, shuffle=False)
